...
name = raw_input ("\033[91mAp ka Nama ?(Hassan-Romeo) : ")																	
																	
if name == (""):																	
     print '\x1b[1;92mReal Nama istmal karain Hassan-Romeo :V'																	
     os.sys.exit()																	
     os.sys.exit()																	
...
if password == ("Hassan007"):																	
     os.system('clear')																	
																	
     print 'Assalamu.alaikum ' + name + ' Welcome'																	
     time.sleep(0.8)																	
     print 'Welcome ' + name + ' Hassan-Romeo'																	
     time.sleep(0.8)																	
     print 'Semoga beruntung ' + name + ' Hassan-Romeo'																	
     time.sleep(0.8)																	
     ...
     time.sleep(0.8)																	
     print 'Hassan-Romeo ' + name + ' Agar Facebook  tools Galat ho gaya  <https://www.facebook.com/rendi.andika.3133>'																	
     time.sleep(0.8)																	
     print '[*]Ingat Ya Untuk ' + name + ' [~]Untuk Fb anda tidak Sesi/Kekunci Login Opera mini..!!'																	
     time.sleep(1.2)																	
     																	
else:																	
     print ("Ap ka Darj kia password Galat ha Hassan-Romeo sy help lain (+923129575809)")																	
     os.sys.exit()																	
#-Out-#																	
def keluar():																	
